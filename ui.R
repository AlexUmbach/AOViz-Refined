        ...
        #BubbleTableOut {
          zoom: 0.80;
                          ...
                          sidebarLayout(
                            ...
                            mainPanel(width = 9,
                                      ...
                                      box(
                                        ...
                                        img(src="ASVExample.png",height = "100%", width = "100%"),
                                        width = 13,
                                        style = "background-color:#FFFFFF; border-color:#ffffff; border-style: solid; border-width: 1.5px; margin-left:0px; margin-right:30px; padding: 10px",
                                      ),
                                      box(
                                        ...
                                        img(src="CollASVExample.png",height = "60%", width = "60%"),
                                        width = 13,
                                        style = "background-color:#FFFFFF; border-color:#ffffff; border-style: solid; border-width: 1.5px; margin-left:0px; margin-right:30px; padding: 10px",
                                      ),
                                      box(
                                        ...
                                        img(src="MetaExample.png",height = "60%", width = "60%"),
                                        width = 13,
                                        style = "background-color:#FFFFFF; border-color:#ffffff; border-style: solid; border-width: 1.5px; margin-left:0px; margin-right:30px; padding: 10px",
                                      ),
                                      box(
                                        p("Lastly, AOViz will accept a list of ASVs used for downstream filtering. For example, if you have a list of contaminants, you can upload them to AOViz and remove them or higlight them (see upload tab)"),
                                        img(src="ContamExample.png",height = "60%", width = "60%"),
                                        width = 13,
                                        style = "background-color:#FFFFFF; border-color:#ffffff; border-style: solid; border-width: 1.5px; margin-left:0px; margin-right:30px; padding: 10px",
                                      ),
                                      br(),
                 ...
                 tabPanel("Data upload",
                          sidebarLayout(
                            sidebarPanel(h3("Please upload your data"),
                                         fileInput("MainFile","ASV/OTU table"),
                                         div(
                                         checkboxInput("IsMainCollapsed","Is this a collapsed table?",value = FALSE),
                                         style = "margin-top: -15px;margin-bottom: 30px; font-size: 14px;"),
                 ...
                 tabPanel("Read plot", value = "readtab",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              hr(style = "border-width: 3px; border-color:#A9A9A9"),
                              fluidRow(
                                column(6,numericInput("ReadPlotOutW",label = "Plot width",value = 600)),
                                column(6,numericInput("ReadPlotOutH",label = "Plot height",value = 400)),
                              ),
                              fluidRow(
                                column(6, downloadButton("ReadDownload","Save figure", style = "width: 100%;")),
                                column(6, downloadButton("ReadTableDownload", "Download table", style = "width: 100%;")),
                              ),
                              br(),
                              # actionButton("ReadStartButton",label = "Start!", style = "width: 100%;"),
                              width = 3,
                              style = "overflow-y:scroll; max-height: 850px; position:relative;border-color:#000000"
                            ...
                            mainPanel("",
                                      ...
                                      actionButton("ReadStartButton",label = "Generate Plot!", style = "width: 100%; height: 80px; font-size: 24px; background-color: lightblue;"),
                                      br(),
                                      br(),
                 ...
                 tabPanel("Taxonomy relative abundance",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              fluidRow(
                                column(6,numericInput("TaxaPlotOutW",label = "Plot width",value = 600)),
                                column(6,numericInput("TaxaPlotOutH",label = "Plot height",value = 400)),
                              ),
                              fluidRow(
                                column(6, downloadButton("BarDownload","Save figure", style = "width: 100%;")),
                                column(6, downloadButton("BarTableDownload", "Download table", style = "width: 100%;")),
                              ),
                              br(),
                            ...
                            mainPanel(width = 9,
                                      ...
                                      actionButton("BarStartButton",label = "Generate Plot!", style = "width: 100%; height: 80px; font-size: 24px; background-color: lightblue;"),
                 ...
                 tabPanel("Relative Abundance Bubble plot",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              selectInput("BubbleTaxSort","By what taxonomic level will the y-axis be sorted?",choice = c("Phylum","Class","Order","Family","Genus","Species","Sub1","Sub2","Sub3","Sub4")),
                              checkboxInput("BubbleRename","Do you want to rename your samples on the plot using a SampleShort column?", FALSE),
                              hr(style = "border-width: 3px; border-color:#A9A9A9"),
                              checkboxInput("BubbleAddLegend","Add colour legend to the plot?", FALSE),
                              ...
                              hr(style = "border-width: 3px; border-color:#A9A9A9"),
                              radioButtons("BubblePanelBorder","Do you want panel borders?",choices = c("Yes","No"),selected = "Yes", inline = TRUE),
                              ...
                              fluidRow(
                                ...
                                column(6, downloadButton("BubbleTableDownload", "Download table", style = "width: 100%;")),
                              ),
                              br(),
                            ...
                            mainPanel(width = 9,
                                      ...
                                      actionButton("BubbleStartButton",label = "Generate Plot!", style = "width: 100%; height: 80px; font-size: 24px; background-color: lightblue;"),
                 ...
                 tabPanel("Bray-Curtis PCoA Triplot",
                          sidebarLayout(
                            sidebarPanel(
                              radioButtons("PDistMatrix","Which PCoA?",c("BrayCurtis","Jaccard"),selected = "BrayCurtis",inline = TRUE),
                              ...
                              sliderInput("PEnvScaling","Modify triplot arrow scaling",min = 0, max = 0.5,value = 0.02,step = 0.01),
                              hr(style = "border-width: 3px"),
                              ...
                              fluidRow(
                                column(6,numericInput("PPlotOutW",label = "Plot width",value = 600)),
                                column(6,numericInput("PPlotOutH",label = "Plot height",value = 400)),
                              ),
                              fluidRow(
                            ...
                            mainPanel(width = 9,
                                      ...
                                      actionButton("PStartButton",label = "Generate Plot!", style = "width: 100%; height: 80px; font-size: 24px; background-color: lightblue;"),
                 ...
                 tabPanel("UniFrac PCoA Triplot",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              sliderInput("UniPEnvScaling","Modify triplot arrow scaling",min = 0, max = 0.5,value = 0.02,step = 0.01),
                              hr(style = "border-width: 3px"),
                              ...
                              fluidRow(
                                column(6,numericInput("UniPlotOutW",label = "Plot width",value = 600)),
                                column(6,numericInput("UniPlotOutH",label = "Plot height",value = 400)),
                              ),
                              fluidRow(
                            ...
                            mainPanel(width = 9,
                                      ...
                                      actionButton("UniStartButton",label = "Generate Plot!", style = "width: 100%; height: 80px; font-size: 24px; background-color: lightblue;"),
                 ...
                 tabPanel("Build Your Own Triplot",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              numericInput("BYOPEnvScaling","Modify triplot arrow scaling",min = 0, max = 100, value = 2),
                              hr(style = "border-width: 3px"),
